...
if __name__ == '__main__':
    ...
    shutil.copyfile(checkpoint_callback.best_model_path, args.ExpConfig.exp_dir + '/net_best.ckpt')
    shutil.copyfile(checkpoint_callback.last_model_path, args.ExpConfig.exp_dir + '/bet_last.ckpt')
